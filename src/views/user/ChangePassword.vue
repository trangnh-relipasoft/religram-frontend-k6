    ...
    <div class="footer">
      <div class="post-event">
        <span class="icon-home">
          <a title>
            <img alt src="images/footer-icon-home.png" />
          </a>
        </span>
        <span class="icon-search">
          <a title>
            <img alt src="images/footer-icon-search.png" />
          </a>
        </span>
        <span class="icon-plus">
          <a title>
            <img alt src="images/footer-icon-plus.png" />
          </a>
        </span>
        ...
        <span class="icon-my-page">
          <a title>
            <img alt src="images/footer-icon-my-page.png" />
          </a>
        </span>
      </div>
    </div>
